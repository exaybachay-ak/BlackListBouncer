...
function displayMenu
{
  ...
  write-output "2. Crap I messed everything up, UNBLOCK IT ALL!!!"
  write-output "3. Just add one host to block"
  write-output "4. Black a comma separated list of hosts"
  write-output "5. Show me the current routing table"
  write-output "6. Exit"
  write-output "============================================="
